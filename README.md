...
The series of choropleth maps reflects census tract-level data. It may have been better to use block group-level data, but I was concerned about high margins of error if I used a smaller geography.  Aside from the dot density map, all of the maps are projected to EPSG 2227. 
